...
public:
    ...
    {
        client_ = create_client<amr_msgs::srv::AddTwoInts>("add_two_ints");

        auto request = std::make_shared<amr_msgs::srv::AddTwoInts::Request>();
        request->a = a;
        request->b = b;
...
private:
    rclcpp::Client<amr_msgs::srv::AddTwoInts>::SharedPtr client_;

    void responseCallback(rclcpp::Client<amr_msgs::srv::AddTwoInts>::SharedFuture future)
    {
        if(future.valid())
        {
