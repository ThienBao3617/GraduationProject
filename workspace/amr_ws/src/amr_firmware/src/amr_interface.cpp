...
AmrInterface::~AmrInterface()
{
    if (arduino_.IsOpen())
    {
        ...
        {
            RCLCPP_FATAL_STREAM(rclcpp::get_logger("AmrInterface"), "Something went wrong while closing connection with port " << port_);
        }
    }
}
...
CallbackReturn AmrInterface::on_activate(const rclcpp_lifecycle::State &)
{
    ...
    {
        RCLCPP_FATAL_STREAM(rclcpp::get_logger("AmrInterface"), "Something went wrong while interacting with port " << port_);
        return CallbackReturn::FAILURE;
    }

    RCLCPP_INFO(rclcpp::get_logger("AmrInterface"), "Hardware started, ready to take commands");
    return CallbackReturn::SUCCESS;
}
...
hardware_interface::return_type AmrInterface::read(const rclcpp::Time &, const rclcpp::Duration &)
{
                                                          ...
                                                          const rclcpp::Duration &)
{
    ...
    {
        RCLCPP_ERROR_STREAM(rclcpp::get_logger("AmrInterface"), "Something went wrong while sending the message "
