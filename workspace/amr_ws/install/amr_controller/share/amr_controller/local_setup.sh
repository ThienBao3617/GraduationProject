...
: ${AMENT_CURRENT_PREFIX:="/home/skytold/workspace/amr_ws/install/amr_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amr_controller/environment/pythonpath.sh"
